...
document.addEventListener("DOMContentLoaded", function () {
  var svg = document.getElementById("vivus-svg");
  var loop = function loop(animation) {
    animation.stop().reset().play();
  };
  if (svg) {
    var animatedSVG = new Vivus(svg, {
      duration: 200,
      start: "autostart"
    }, function () {
      loop(animatedSVG);
...
/* harmony import */ var _downloadPdf__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./downloadPdf */ "./resources/js/downloadPdf.js");
/* harmony import */ var _downloadPdf__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_downloadPdf__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./animations */ "./resources/js/animations.js");
...
/* harmony import */ var _gsap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./gsap */ "./resources/js/gsap.js");
/* harmony import */ var _pageTransition__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pageTransition */ "./resources/js/pageTransition.js");
/* harmony import */ var _pageTransition__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_pageTransition__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _cookieConsent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./cookieConsent */ "./resources/js/cookieConsent.js");
/* harmony import */ var _cookieConsent__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_cookieConsent__WEBPACK_IMPORTED_MODULE_8__);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(Observer);
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".a", {
    x: 500,
    duration: 3,
    scrollTrigger: {
      start: "0 center",
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".b", {
    x: 500,
    rotation: 360,
    duration: 6,
    scrollTrigger: {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".d", {
    scale: 0.2,
    opacity: 0.1,
    duration: 4,
    x: 500,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".c", {
    x: 500,
    motionPath: {
      path: [{
        x: 100,
  ...
  function moveBubbles(event, deltaX, deltaY) {
    var el = event.target.closest(".bubble");
    var t = event.type.startsWith("touch") ? 5 : 1;
    el.style.animation = "none";
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(el, {
      xPercent: "+=".concat(deltaX * t),
      yPercent: "+=".concat(deltaY * t),
      rotation: "-=".concat(deltaX * t),
      duration: 3,
      ease: "expo.out",
  ...
  document.querySelectorAll(".bubble").forEach(function (bubble) {
    bubble.addEventListener("touchstart", function (event) {
      var randomDirectionX = getRandomInt(20);
      var randomDirectionY = getRandomInt(20);
      moveBubbles(event, randomDirectionX, randomDirectionY);
    });
    Observer.create({
      target: bubble,
      type: "pointer,mouse,scroll",
      onMove: function onMove(self) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var snapTriggers = [];
  var scrollStarts = [0];
  snapScroll = function snapScroll(value) {
    return value;
  };
  ...
  panels.forEach(function (panel, i) {
    snapTriggers[i] = ScrollTrigger.create({
      ...
      pin: true,
        ...
        return "+=".concat(panel.scrollHeight);
      },
      pinSpacing: true,
  ...
  ScrollTrigger.addEventListener("refresh", function () {
    scrollStarts = snapTriggers.map(function (trigger) {
  ...
  ScrollTrigger.observe({
    type: "wheel,touch",
    onChangeY: function onChangeY(self) {
      if (!scrollTween) {
        var scroll = (self.scrollY + self.deltaY, self.deltaY > 0 ? 1 : -1);
